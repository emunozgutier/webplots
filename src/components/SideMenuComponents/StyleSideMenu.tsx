...
const StyleSideMenu: React.FC = () => {
        ...
        return (
            <div className="mb-4 bg-white border rounded p-3 shadow-sm">
                <div className="d-flex justify-content-between align-items-center mb-2">
                    <span className={`fw-bold ${!isEnabled ? 'text-muted' : ''}`}>{title}</span>
                ...
                <div className={!isEnabled ? 'opacity-50' : ''} style={{ pointerEvents: isEnabled ? 'auto' : 'none' }}>
                    <div className="mb-3">
    ...
    return (
        <div className="p-3 w-100" style={{ height: '100%', overflowY: 'auto' }}>
            ...
            {renderMappingBlock('Saturation (Intensity)', colorData.saturation, setSaturation, 'number')}
